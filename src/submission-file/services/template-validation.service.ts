...
export class TemplateValidationService {
  ...
  async executeTemplateValidationReserveBalancingGasContract(shipper_id: number, contract_code_id: number, nomination_type_id: number, gAuserType: any, todayStart: Date, todayEnd: Date, startDateEx: string, sheet1: any): Promise<TemplateValidationResult> {
    try {
      ...
      // ===== STEP 13: CONTRACT CAPACITY VALIDATION =====
      // already get reserve balancing gas contract object in STEP 6
  ...
  validateWeeklyDailyNominationDate(nomination_type_id: number, startDateEx: string, sheet1: any) {
    ...
    if (nomination_type_id === 2) {
      ...
      if (sundayDate.format('DD/MM/YYYY') !== sheet1?.data[2][14]) {
      ...
      if (mondayDate.format('DD/MM/YYYY') !== sheet1?.data[2][15]) {
      ...
      if (tuesdayDate.format('DD/MM/YYYY') !== sheet1?.data[2][16]) {
      ...
      if (wednesdayDate.format('DD/MM/YYYY') !== sheet1?.data[2][17]) {
      ...
      if (thursdayDate.format('DD/MM/YYYY') !== sheet1?.data[2][18]) {
      ...
      if (fridayDate.format('DD/MM/YYYY') !== sheet1?.data[2][19]) {
      ...
      if (saturdayDate.format('DD/MM/YYYY') !== sheet1?.data[2][20]) {
